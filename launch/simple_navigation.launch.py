...
def generate_launch_description():
    ...
    package_dir = get_package_share_directory('lucia_navigation2')
    #urdf = os.path.join(package_dir, 'urdf', 'wheel_robot_simple.urdf')
    rviz = os.path.join(package_dir, 'rviz', 'simple_nav2.rviz')
    #world = os.path.join(package_dir, 'world', 'maze.world')
    map = os.path.join(package_dir, 'map', 'map_e3.yaml')
    nav2_params = os.path.join(package_dir, 'param', 'nav2_minimal.yaml')
